...
- Team members and roles for this project:
  ...
  2.  **Data wrangler** (loads data, checks quality, makes a clean table): [Your Member Name(s)]{.blue}
  3.  **Visualization designer** (builds plots, improves readability): [Your Member Name(s)]{.blue}
  4.  **Storyteller** (writes narrative, connects visuals to claims): [Your Member Name(s)]{.blue}
