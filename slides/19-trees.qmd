...
::: center
[*Instead of fitting one single equation, a tree repeatedly splits the **predictor** space into regions.*]{.green}
:::
...
-   **Leaf (terminal) node**: the final prediction <!-- - **Path**: the sequence of questions followed by one observation -->
:::
