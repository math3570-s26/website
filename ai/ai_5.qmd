...
#| echo: false
#| column: margin
knitr::include_graphics("../images/QRCode_ai5.png")
```
...
Please scan the QR code, or go to <https://forms.cloud.microsoft/r/pTkMpv3Qed> to share what you learned from this activity.