...
-   **Advanced data analytics and computing** <!-- + MATH 4720 Statistical Methods --> <!-- + MATH 4740 Biostatistical Methods -->
...
`r emo::ji("point_right")` Wouldn't it be great to add both languages to your resume! `r emo::ji('sunglasses')` <!-- - [Why R](https://github.com/matloff/R-vs.-Python-for-Data-Science) -->
