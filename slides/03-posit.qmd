...
format: 
  live-revealjs: 
    output-file: 03-posit-slides.html
webr:
  cell-options:
    autorun: false
  packages:
...
#| out-width: 60%
#| fig-align: center
knitr::include_graphics("images/03-posit/posit_logo.png")
```
:::
...
*Step 3*: [**Student**]{.red} **\> Sign Up** using your Marquette email address.
:::
...
#| out-width: 50%
#| fig-align: center
knitr::include_graphics("images/03-posit/posit-plan.png")
```
...
Subject Posit Cloud Invitation

Message https://posit.cloud/spaces/736333/join?access_code=aFYGcnYq1lwDmoGnRD37aAoftM7iNpCX5y81Mra4
...
#| out-width: 50%
#| fig-align: center
#| fig-link: https://docs.posit.co/cloud/
...
```{r}
#| fig-link: https://ggplot2.tidyverse.org/index.html
#| out-width: 80%
