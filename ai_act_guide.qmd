...
-   [Group submits]{.blue}: **(1) AI Interaction Log**, **(2) Human Authored Synthesis**, **(3) Slides**. See @sec-submit.
-   [Each student submits]{.blue}: **Individual Reflection (150 to 200 words)** See @sec-submit.\
...
\[Note:\] Two students may share the same role for the 4-people team.
...
## Required Deliverables {#sec-submit}
