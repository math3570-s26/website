...
#| echo: false
#| column: margin
knitr::include_graphics("../images/QRCode_ai6.png")
```


## Individual Reflection (presenting students)
...
Please scan the QR code, or go to <https://forms.cloud.microsoft/r/4ryuhhwQ8r> to share what you learned from this activity.
