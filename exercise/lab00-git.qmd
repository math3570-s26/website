...
- Share your GitHub **username** at <https://forms.office.com/r/RUmTn3gadG>, so I can invite you to join our course organization **math3570-s26**. 
...
#| out-width: 78%
#| label: join-org
knitr::include_graphics("../slides/images/04-git/join-org-2026.png")
```
...
```{r}
#| label: github-auth-4
knitr::include_graphics("../slides/images/04-git/github-auth-4-26.png")
```
...
```{r}
#| label: github-auth-5
knitr::include_graphics("../slides/images/04-git/github-auth-5-26.png")
```
...
knitr::include_graphics("../slides/images/04-git/clone-repo-link-2026.png")
```
...
knitr::include_graphics("../slides/images/04-git/paste-gh-repo-url-2026.png")
```
...
knitr::include_graphics("../slides/images/04-git/rcloud_project_hw00_2026.png")
```
