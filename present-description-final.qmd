---
title: "MATH/COSC 3570 Final Project Guidelines"
date-modified: today
...
A report template **qmd** file can be download
<a href="./documents/final_project_report_template_checked.qmd" download>here</a>

A report template **PDF** file can be download [here](./final_project_report_template_checked.qmd)
...
[You are welcome to use another method, but please get approval from Dr. Yu first.]{.blue}
