...
format: 
  live-revealjs: 
    output-file: 20-pca-slides.html
    df-print: default
webr:
  cell-options:
    autorun: false
...
#| echo: false
#| purl: false
knitr::include_graphics("./images/20-pca/drawing.png")
```
...
knitr::include_graphics("./images/20-pca/pca.gif")
```
...
knitr::include_graphics("./images/20-pca/iris.png")
```
...
print(pd.DataFrame(result, columns=['PC1', 'PC2', 'PC3', 'PC4'], index=USArr.columns))
```
...
print(pd.DataFrame(X_pc, columns=['PC1', 'PC2', 'PC3', 'PC4'], index=USArr.index))
```
