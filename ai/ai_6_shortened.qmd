...
3. Run **exactly 3 purposeful AI prompts** that cover workflow design, leakage, evaluation, and interpretation. [Step 2](#step-2-use-ai-strategically) in Tasks.
4. Audit the workflow and complete checklist items 1 to 8. [Step 4](#step-4-audit-build-and-evaluate-the-classification-workflow)
...
- Group submissions
  ...
  - Slides for an 8 to 10 minute presentation
- Individual submission
  - Individual Reflection (120 to 180 words)
...
Use **exactly 3 meaningful prompts**. Your prompts should be purposeful and iterative.

Prompt requirements

- 1 prompt asking AI to propose a reproducible binary classification workflow
- 1 prompt asking AI how to detect or think about target leakage or suspicious predictors
- 1 prompt asking AI about evaluation, interpretation, or trust in the workflow
...
If your model provides predicted probabilities, compare **two** classification thresholds, such as 0.50 and 0.30.
...
**Optional extension: Brief grouped performance check**

If time allows, choose one grouping variable such as `region`, `senior`, or `contract_type`.

- Report one metric by group, or compare confusion matrix patterns across groups.
- Briefly explain whether overall performance hides meaningful subgroup differences.
:::
...
Write **120 to 180 words** answering:
