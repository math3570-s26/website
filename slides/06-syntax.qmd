---
title: 'R `r fontawesome::fa("r-project")` and Python `r fontawesome::fa("python")` '
...
format: 
  live-revealjs: 
    output-file: 06-syntax-slides.html
# webr:
#   cell-options:
#     autorun: false
#   packages:
...
#| fig-align: center
#| out-width: 70%
knitr::include_graphics("./images/06-syntax/console-r-26.png")
```
...
```{r}
#| fig-align: center
knitr::include_graphics("./images/06-syntax/console-py-26.png")
```
...
```{r}
knitr::include_graphics("./images/06-syntax/console-py-quit-26.png")
```
...
## Arithmetic and Logical Operators {visibility="hidden"}
...
## Sequence of Numbers {visibility="hidden"}
...
<span style="color:green"> **05-R Data Type Summary** </span>
...
## [Tuples](https://docs.python.org/3/tutorial/datastructures.html#tuples-and-sequences) {visibility="hidden"}
...
## Tuples Functions and Methods {visibility="hidden"}
...
<span style="color:green"> **06-Python Data Structure** </span>
...
<span style="color:blue"> **07-Plotting (Optional)** </span>
...
<!-- - *Volunteer pairs teach us how to make beautiful plots on Thursday (Feb 13)!* -->
