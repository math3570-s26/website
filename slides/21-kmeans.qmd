...
format: 
  live-revealjs: 
    output-file: 21-kmeans-slides.html
    df-print: default
webr:
  cell-options:
    autorun: false
...
knitr::include_graphics("./images/21-kmeans/clustering.png")
```
...
knitr::include_graphics("./images/21-kmeans/kmeans.png")
```
...
knitr::include_graphics("./images/21-kmeans/kmeans_algo.png")
```
...
knitr::include_graphics("./images/21-kmeans/kmeans_local.png")
```
